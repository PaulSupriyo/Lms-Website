    ...
    from-cyan-100/70 '></div>
      ...
      {/*review and ratings*/}
        <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
          ...
          <div className='flex'>{[...Array(5)].map((_,i)=>(<img key={i} 
      ...
      <p className='text-gray-500'>({courseData.courseRatings.length} 
        {courseData.courseRatings.length    > 1 ? 'ratings' : 'rating'}) </p>
         <p className='text-blue-600'>{courseData.enrolledStudents.length} 
          {courseData.enrolledStudents.length 
         > 1 ? 'students' : 'student'}</p>
          </div>  

    <p className='text-sm'>Course by <span className='text-blue-600 underline'>LearnLand</span></p>   
         ...
         <div className='py-20 text-sm md:text-default'>
          ...
          <p className='pt-3 rich-text' dangerouslySetInnerHTML={{__html:
